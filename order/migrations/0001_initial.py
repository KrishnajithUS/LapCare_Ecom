# Generated by Django 4.1.1 on 2022-10-04 08:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0020_products_offer_product'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discountnew', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('order_cancel', models.BooleanField(blank=True, default=False)),
                ('status', models.CharField(choices=[('Cancelled', 'Cancelled'), ('Pending', 'Pending'), ('Order Confirmed', 'Order Confirmed'), ('Out for Delivery', 'Out for Delivery'), ('Delivered', 'Delivered')], default='New', max_length=50)),
